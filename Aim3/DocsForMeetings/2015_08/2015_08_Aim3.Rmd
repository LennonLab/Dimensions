...
```{r, results = 'hide', echo=FALSE, message = FALSE, warning = FALSE}
# We used a source code file that includes a function for reading in output files from community sequencing software `mothur` (http://www.mothur.org/).
source("~/GitHub/Dimensions/Aim3/bin/MothurTools.R")
# We also generated code for constructing species-area relationships by aggregating sites at random, with or without respect to distance
