...
### 1.) Dependence of the taxa-area relationship on detection of rare taxa
...
cutoffs <- c(15, 30, 60, 125, 250)#, 500, 1000, 2000, 4000, 8000, 16000, 22000)
...
ggplot(z.df, aes(cutoff, value)) + 
  ...
  labs(x= "Number of OTU's", y="Slope of the TAR") +
  labs(title="") +
