...
tax <- read.tax(taxonomy = "~/GitHub/Dimensions/Aim3/Mothur/INPonds.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.an.unique_list.0.03.cons.taxonomy")
```
