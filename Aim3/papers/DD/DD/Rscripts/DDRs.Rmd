...
active.weighted.dist <- log10(1 - vegdist(active.comm, method=metric, binary=FALSE))
all.weighted.dist <- log10(1 - vegdist(all.comm, method=metric, binary=FALSE))
...
df <- data.frame(geo.dist.ls, active.weighted.dist.ls[, 3], all.weighted.dist.ls[, 3], active.presabs.dist.ls[, 3], all.presabs.dist.ls[, 3])
