...
```{r}
file <- paste("~/GitHub/Dimensions/Aim3/papers/DD/DD/figs/CCA_Geo_Dist.png", sep="")
png(filename=file)
...
plot(geo.dist, all.cca1.dist, xaxt = "s", las = 1, 
   ylab="CCA Distance", xlab="Distance, km", col = "azure4", 
   cex.lab=1.5, cex.main=2, main="All")
...
plot(geo.dist, active.cca1.dist, xaxt = "s", las = 1, 
   ylab="CCA Distance", xlab="Distance, km",col = "azure4", 
   cex.lab=1.5, cex.main=2, main="Active")
