...
```{r}
file <- paste("~/GitHub/Dimensions/Aim3/papers/DD/figs/CCA_Geo_Dist.png", sep="")
...
plot(geo.dist, all.cca1.dist, xaxt = "s", las = 1, 
   ...
   cex.lab=1.5, cex.main=2, main="CCA, all")
...
plot(geo.dist, active.cca1.dist, xaxt = "s", las = 1, 
   ylab="Env. Distance", xlab="Distance, km",col = "azure4", 
   cex.lab=1.5, cex.main=2, main="CCA, active")
