...
# Initiate Plot
plot(scores(active.cca, display = "wa"), xlim = c(-2, 2), ylim = c(-1, 1.5),
...
legend("bottomleft", legend = levels.short, bty = "n", col = colors.short, 
       pch = 1)
...
text(vectors[,1] * 2.5, vectors[, 2] * 2, pos = 3, 
...
# Initiate Plot
plot(scores(all.cca, display = "wa"), xlim = c(-2, 4), ylim = c(-2, 2),
     xlab = paste("CCA 1 (", cca.explainvar1, "%)", sep = ""),
     ylab = paste("CCA 2 (", cca.explainvar2, "%)", sep = ""),
...
#     labels = row.names(scores(all.cca, display = "wa")))

legend("topright", legend = levels.short, bty = "n", col = colors.short, 
       pch = 1)
...
text(vectors[, 1] * 3, vectors[, 2] * 3, pos = 3, 
     labels = row.names(vectors))
