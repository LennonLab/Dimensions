...
The species-area relationship (SAR) describes the rate at which species are 
discovered with increasing area. The SAR one of ecology's oldest and most 
intensively studied patterns (Arrhenius1921) and is usually expressed in the
form of a power-law: $S = cA^{z}$ where *z* is the scaling exponent, *S* is 
species richnness and *A* is area. This formulation predicts a rate of increase
in *S* that is approximately linear in log-log space. 
That is, $log(S) = c + zlog(A)$, .
