...
# K is 0.278 suggesting les signal than expected under Brownian
...
# plot(log.traits$a, log.traits$A) # r = -0.61, 
# plot(log.traits$a, log.traits$Lag) # r = -0.44
...
plot(log.traits$a, log.traits$A,
     xlim = c(1.5, 7.5), ylim = c(-0.5, 4.1),
     pch = 22, bg = "white", lwd = 2, bty = "n",
     cex = 2, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
     las = 1, ylab = "", xlab = "")
box(lwd = 2)

mtext(side = 2, expression('Yield (a'[600]*')'), line = 3.5, cex = 1.5)
...
lines(phy.a.lines[,1], phy.a.lines[,2], lwd = 2, lty = 5, col = "red")
